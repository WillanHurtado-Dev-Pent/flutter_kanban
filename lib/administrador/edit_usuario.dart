...
class EditUsuario extends StatefulWidget {
  @override
  EditUsuarioState createState() {
    return EditUsuarioState();
  }
}
...
class EditUsuarioState extends State<EditUsuario> {
  ...
  Widget Scafold(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(title: Text('EDITAR USUARIO'),backgroundColor: Colors.blue.shade900,),
      drawer: SideNav(),
      body: SafeArea(
  ...
  Widget botonNuevo(BuildContext context) {
    return Container(
      width: 300,
      height: 60,
      child: RaisedButton(
